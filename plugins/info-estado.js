...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const wm = 'MISHIBOT Bot';
  const info = ` ${tradutor.texto1[0]}

  ${tradutor.texto1[1]} Alexn
  ${tradutor.texto1[2]} +541123202387
  ...
  const Message = {
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://chat.whatsapp.com/LOXfLTwW0Sh5k8RTFhkclY",
        mediaType: 2,
        previewType: "pdf",
        title: "MISHIBOT",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://chat.whatsapp.com/LOXfLTwW0Sh5k8RTFhkclY",
      },
    },
    caption: info,
    footer: wm,
